...
<div class="container ">
    <nav class="navbar navbar-light bg-white shadow">
        <ul class="nav">
            <li class="nav-item">
                <a href="./">
                    <img src="./images/MZ.png" class="mt-1"
                         style="width: 100px">
                </a>
            </li>
        </ul>
            ...
            <div class="passport bg-white">
                ...
                <div class="input-group mt-4 ">
                    ...
                    <div class="col-4 p-0 pl-2 pt-0">
						<!-- 验证码图片 -->
                        <img id="imgVerifyCode" src="/mz_reader/verify_code"
...
<script>
    ...
    function reloadVerifyCode(){
        //请在这里实现刷新验证码
        $("#imgVerifyCode").attr("src", "/mz_reader/verify_code?ts=" + new Date().getTime());
    }
